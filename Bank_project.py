...
win=Tk()
win.state("zoomed")
win.configure(bg="#5bccf6")

lbl_title=Label(win,text="National Bank",bg="#5bccf6",font=('Arial',70,'bold','underline'))
lbl_title.pack(pady=10,padx=50)

img=Image.open("Bank.png").resize((375,150))
imgtk=ImageTk.PhotoImage(img,master=win)

lbl_bank=Label(win,image=imgtk)
lbl_bank.place(x=1,y=2)


def login_screen():
    frm=Frame(win)
    frm.configure(bg="#fcde67")
    ...
    lbl_acn=Label(frm,text="Account No",bg="#fcde67",font=('Arial',20,'bold'))
    ...
    lbl_pass=Label(frm,text="Password",bg="#fcde67",font=('Arial',20,'bold'))
    lbl_pass.place(relx=.3,rely=.23)
    
    e_pass=Entry(frm,font=('Arial',20,'bold'),bd=5,show="*")
    e_pass.place(relx=.42,rely=.23)
    
    btn_login=Button(frm,text="Login",command=login_db,font=('Arial',20,'bold'),bd=5,bg="#5bccf6")
    btn_login.place(relx=.42,rely=.35)
    
    btn_reset=Button(frm,text="Reset",command=reset,font=('Arial',20,'bold'),bd=5,bg="#5bccf6")
    btn_reset.place(relx=.51,rely=.35)
    
    btn_fp=Button(frm,text="Forget Password",command=forgot,font=('Arial',20,'bold'),bd=5,bg="#5bccf6")
    btn_fp.place(relx=.42,rely=.48)
    
    btn_new=Button(frm,text="Open New Account",command=newuser,width=15,font=('Arial',20,'bold'),bd=5,bg="#5bccf6")
    btn_new.place(relx=.42,rely=.6)
...
def newuser_screen():
    ...
    btn_back=Button(frm,text="back",command=back,font=('Arial',20,'bold'),bd=5,bg="#5bccf6")
    btn_back.place(relx=0,rely=0)
 
    lbl_name=Label(frm,text="Name",bg="#fcde67",font=('Arial',20,'bold'))
    lbl_name.place(relx=.3,rely=.05)
    
    e_name=Entry(frm,font=('Arial',20,'bold'),bd=5)
    e_name.place(relx=.42,rely=.05)
    e_name.focus()
    
    lbl_pass=Label(frm,text="Password",bg="#fcde67",font=('Arial',20,'bold'))
    lbl_pass.place(relx=.3,rely=.15)
    
    e_pass=Entry(frm,font=('Arial',20,'bold'),bd=5)
    e_pass.place(relx=.42,rely=.15)
    
    
    lbl_email=Label(frm,text="E-mail Id",bg="#fcde67",font=('Arial',20,'bold'))
    lbl_email.place(relx=.3,rely=.25)
    
    e_email=Entry(frm,font=('Arial',20,'bold'),bd=5)
    e_email.place(relx=.42,rely=.25)
    
    lbl_mob=Label(frm,text="Phone No.",bg="#fcde67",font=('Arial',20,'bold'))
    lbl_mob.place(relx=.3,rely=.35)
    
    e_mob=Entry(frm,font=('Arial',20,'bold'),bd=5)
    e_mob.place(relx=.42,rely=.35)
    
    lbl_type=Label(frm,text="Accn Type",bg="#fcde67",font=('Arial',20,'bold'))
    lbl_type.place(relx=.3,rely=.45)
    
    cb_type=Combobox(frm,values=['Saving','Current'],font=('Arial',20,'bold'))
    cb_type.current(0)
    cb_type.place(relx=.42,rely=.45)
    
    btn_open=Button(frm,text="Open",command=openacn_db,font=('Arial',20,'bold'),bd=5,bg="#5bccf6")
    btn_open.place(relx=.45,rely=.55)
    
    btn_reset=Button(frm,text="Reset",font=('Arial',20,'bold'),bd=5,bg="#5bccf6")
    btn_reset.place(relx=.55,rely=.55)
...
def forgotpass_screen():
    ...
    lbl_acn=Label(frm,text="ACN",bg='#fcde67',font=('Arial',20,'bold'))
    ...
    lbl_email=Label(frm,text="Email",bg='#fcde67',font=('Arial',20,'bold'))
    ...
    lbl_mob=Label(frm,text="Mob",bg='#fcde67',font=('Arial',20,'bold'))
    ...
    btn_get=Button(frm,text="Generate",command=get_db,font=('Arial',20,'bold'),bd=5,bg="#5bccf6")
...
def welcome_screen(): 
    ...
    def checkbal():
        ...
        lbl_acn=Label(ifrm,text=f"Account Number\t{tup[0]}",bg='white',font=('Arial',20,'bold'),fg='green')
        lbl_acn.place(relx=.3,rely=.1)
        
        lbl_name=Label(ifrm,text=f"Holder Name\t{row[0]}",bg='white',font=('Arial',20,'bold'),fg='green')
        lbl_name.place(relx=.3,rely=.3)
        
        lbl_bal=Label(ifrm,text=f"Available Bal\t{row[1]}",bg='white',font=('Arial',20,'bold'),fg='green')
        lbl_bal.place(relx=.3,rely=.5)
        
        lbl_date=Label(ifrm,text=f"ACN Open Date\t{row[2]}",bg='white',font=('Arial',20,'bold'),fg='green')
    ...
    btn_logout=Button(frm,text="Logout",command=logout,font=('Arial',20,'bold'),bd=5,bg="#5bccf6")
    btn_logout.place(relx=.9,rely=0)

    lbl_wel=Label(frm,text=f"Welcome,{tup[1]}",bg='#fcde67',font=('Arial',20,'bold'),fg='green')
    lbl_wel.place(relx=0,rely=0)
    
    btn_checkbal=Button(frm,text="Check Balance",command=checkbal,width=14,font=('Arial',20,'bold'),bd=5,bg="#5bccf6")
    btn_checkbal.place(relx=0,rely=.1)
    
    btn_deposit=Button(frm,text="Deposit Amount",command=deposit,width=14,font=('Arial',20,'bold'),bd=5,bg="#5bccf6")
    btn_deposit.place(relx=0,rely=.25)
    
    btn_withdraw=Button(frm,text="Withdraw Amount",command=withdraw,width=14,font=('Arial',20,'bold'),bd=5,bg="#5bccf6")
    btn_withdraw.place(relx=0,rely=.4)
    
    btn_transfer=Button(frm,text="Transfer Amount",command=transfer,width=14,font=('Arial',20,'bold'),bd=5,bg="#5bccf6")
    btn_transfer.place(relx=0,rely=.55)
    
    btn_update=Button(frm,text="Update Profile",command=update,width=14,font=('Arial',20,'bold'),bd=5,bg="#5bccf6")
    btn_update.place(relx=0,rely=.7)
    
    btn_trahist=Button(frm,text="History",command=txn_history,width=14,font=('Arial',20,'bold'),bd=5,bg="#5bccf6")
    btn_trahist.place(relx=0,rely=.85)
    
    lbl_page=Label(frm,text="This is Home Page",bg='#fcde67',font=('Arial',30,'bold','underline'),fg='blue')
